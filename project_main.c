/*
Oulun yliopiston Johdatus tietokonejärjestelmiin-kurssin harjoitustyö
...
Joihinkin osioihin on merkitty, kuka on toteuttanut minkäkin osuuden.
Kuitenkin suurin osa työstä on tehty kaikkien tekijöiden tiiviillä
yhteistyöllä, joten kohdat joihin kaikki ovat osallistuneet ei ole
merkitty erikseen tekijää. Harjoitustyössä on käytetty ainestona ja
